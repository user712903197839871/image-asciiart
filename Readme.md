the backend was done in 5 vibecoded minutes :)<br>

this is still under developement!



## dis documentation for dev or smthn
response headers: <br>
- [ERROR] - we fucked up something serious
- [WARNING] - something happened in code, code handles it, but it could lead to behaviour u didnt intend to have, doesn't really occur
- [FAIL] - user's data is shit, so we need to spank him for dat <br> <br>
then comes the message


- [x] add sliders to modify lenght font size, charset
- [x] modify the font-size dynamically
